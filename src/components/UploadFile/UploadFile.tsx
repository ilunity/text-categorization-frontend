...
export const UploadFile: React.FC<UploadFileProps> = ({ value = [], onChange = () => {} }) => {
  ...
  const isDocxFile = (file: UploadChangeParam['file']) =>
    file.type === 'application/vnd.openxmlformats-officedocument.wordprocessingml.document';

  return (
    <Upload.Dragger { ...props } customRequest={ stubRequest } fileList={ value }>
      ...
      <p className="ant-upload-hint">Поддерживаются файлы только формата .docx</p>
    </Upload.Dragger>
  );
};
